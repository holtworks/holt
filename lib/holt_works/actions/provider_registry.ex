defmodule HoltWorks.Actions.ProviderRegistry do
  @moduledoc """
  Structured provider metadata for HoltWorks action catalogs.
  ...
  @table :holtworks_action_providers
  ...
  defp fallback_provider(provider_id) do
    ...
    %{
      ...
      "description" => "HoltWorks action provider #{id}."
    }
  end
