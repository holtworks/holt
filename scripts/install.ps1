# holtworks installer -- generated by tinfoil 0.2.20
#
# Usage (in PowerShell):
#   iex (irm https://raw.githubusercontent.com/holtworks/holtworks/main/scripts/install.ps1)
#   iex "& { $(irm https://raw.githubusercontent.com/holtworks/holtworks/main/scripts/install.ps1) } -Version v1.2.3"
#   iex "& { $(irm https://raw.githubusercontent.com/holtworks/holtworks/main/scripts/install.ps1) } -InstallDir 'C:\tools'"
#
# Or download and run manually:
#   irm https://raw.githubusercontent.com/holtworks/holtworks/main/scripts/install.ps1 -OutFile install.ps1
