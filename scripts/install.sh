...
#   curl -fsSL https://raw.githubusercontent.com/holtworks/holtworks/main/scripts/install.sh | sh -s -- --version v1.2.3
#   curl -fsSL https://raw.githubusercontent.com/holtworks/holtworks/main/scripts/install.sh | sh -s -- --install-dir /usr/local/bin
set -eu
