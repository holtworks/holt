...
#   curl -fsSL https://raw.githubusercontent.com/holtworks/holt/main/scripts/install.sh | sh -s -- --version v1.2.3
#   curl -fsSL https://raw.githubusercontent.com/holtworks/holt/main/scripts/install.sh | sh -s -- --install-dir /usr/local/bin
set -eu
...
# Verify against the combined checksums-sha256.txt uploaded alongside the
# archives.
